// Run this once against your Codex to add/update all the canon entries
// compiled from the Writer's Realm Archive + TBG Support Docs.
//
// Usage:
//   node import-canon.js                          # defaults to http://localhost:3000
//   BASE_URL=https://litty.onrender.com node import-canon.js   # against the live site
//
...
// Existing fields not mentioned here are left untouched by nothing else in
// this script — but a full field replacement happens for any entry with a
// matching title, so review the diff/output before trusting it blindly.

const { entries } = require('./canon-entries');
...
async function main() {
  console.log(`Importing ${entries.length} canon entries into ${BASE_URL} ...\n`);
